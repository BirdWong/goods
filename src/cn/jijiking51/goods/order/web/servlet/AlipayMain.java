...
//    }
    ...
    // 测试当面付2.0生成支付二维码
    public String test_trade_precreate(BaseServlet servlet,String outTradeNo, double money, int sumGoods, List<GoodsDetail> goodsDetailList) {
...
//            + (long) (Math.random() * 10000000L);
        ...
        String body = "购买商品"+sumGoods+"件共+"+money+"元";
...
//        goodsDetailList.add(goods2);
        ...
        switch (result.getTradeStatus()) {
		    ...
		    String realPath = servlet.getServletContext().getRealPath("/alipayimg");
		    String filePath = String.format("/%s.png",
                    outTradeNo);
...
/*
    ...
    // 测试当面付2.0生成支付二维码
    public String test_trade_precreate(double money,int sumGoods,List<GoodsDetail> goodsDetailList) {
        // (必填) 商户网站订单系统中唯一订单号，64个字符以内，只能包含字母、数字、下划线，
        // 需保证商户系统端不能重复，建议通过数据库sequence生成，
        String outTradeNo = "tradeprecreate" + System.currentTimeMillis()
                            + (long) (Math.random() * 10000000L);

    ...
    <div class="admin-content">
            ...
            <div class="am-cf am-padding">
                <div class="am-fl am-cf">
                    <strong class="am-text-primary am-text-lg">
                        <a href="<c:url value='/admin/AdminBookServlet?method=findCategoryAll'/>">图书管理</a>
                    </strong> /
                </div>
            </div>
        ...
        <%--</div>--%>
            ...
            <div class="am-g">
                <div class="am-u-md-4" >
                    <ul class="dropDown-menu menu radius box-shadow">
                        <c:forEach items="${parents}" var="parent">
                            <li class=""><a>${parent.cname}</a>
                                <ul class="menu">
                                    <c:forEach items="${parent.children}" var="child">
                                        <li>
                                            <a href="<c:url value="/admin/AdminBookServlet?method=findByCategory&cid=${child.cid}"/>">
                                                    ${child.cname}
                                            </a>
                                        </li>
                                    </c:forEach>
                ...
                <%--<div class="am-u-md-9 am-u-md-push-3 am-center">--%>
                <%--<button type="button" class="am-btn am-btn-primary am-btn-xs"><a href="<c:url value='/admin/AdminBookServlet?method=addPre'/>" style="color: #fff">添加图书</a></button>--%>
                <%--</div>--%>


                <div class="am-u-sm-6 am-u-md-8 am-u-md-pull-0">
                    <form class="am-form am-form-horizontal am-fl" action="<c:url value='/admin/AdminBookServlet'/>" method="get">
                        <input type="hidden" name="method" value="findByCombination"/>
                        <div class="am-form-group">
                            <label for="bookname" class="am-u-sm-4 am-form-label">书名：</label>
                            <div class="am-u-sm-8">
                                <input type="text" id="bookname" name="bname" placeholder="书名">
                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="author" class="am-u-sm-4 am-form-label">作者：</label>
                            <div class="am-u-sm-8">
                                <input type="text" id="author" name="author" placeholder="输入作者名">
                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="press" class="am-u-sm-4 am-form-label">出版社：</label>
                            <div class="am-u-sm-8">
                                <input type="text" id="press" name="press" placeholder="输入出版社">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            <div class="am-u-sm-9 am-u-sm-push-3">
                                ...
                                <button type="reset" class="am-btn am-btn-primary">重新填写</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="am-u-sm-6 am-u-md-12 am-u-md-pull-0">
                    <button type="button" class="am-btn am-btn-primary am-btn-xs"><a href="<c:url value='/admin/AdminBookServlet?method=addPre'/>" style="color: #fff">添加图书</a></button>
                </div>
